...
model = tflearn.DNN(network, tensorboard_verbose = 3, tensorboard_dir='./logs') # checkpoint_path = '/logs/model_vgg',
...
#model.fit({'input': x_data}, {'target': y_data}, n_epoch = 1, validation_set=({'input': x_val}, {'target': y_val}), show_metric=True, run_id='convnet')
